...
public class StelliumTrigger extends Trigger {
    ...
    public void apply(PlayerData player) {
        ...
        if (operation == Operation.GIVE)
            player.giveStellium(amount.roll(), ResourceUpdateReason.MECHANIC);

            // Set stellium
        else if (operation == Operation.SET)
            player.setStellium(amount.roll(), ResourceUpdateReason.MECHANIC);

            // Take stellium
        else player.giveStellium(-amount.roll(), ResourceUpdateReason.MECHANIC);
    }
}
